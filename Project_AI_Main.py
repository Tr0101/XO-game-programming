...
def checkWinner():
 ...
 if button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X" and button4["text"] == "X" and button5["text"] == "X":
    button1.config(bg="#80ffaa") #[X][X][X][X]
    ...
    button6.config(bg="#80ffaa") #[O][O][O ][]
    button7.config(bg="#80ffaa") #[X][X][X][X]
    ...
    button12.config(bg="#80ffaa") #[O][O][ ][]
    button13.config(bg="#80ffaa") #[X][X][X][X]
    ...
    button17.config(bg="#80ffaa") #[O][O][ ][]
    button18.config(bg="#80ffaa")
#[][][][]
    button19.config(bg="#80ffaa") #[X][X][X][X]
    ...
    button22.config(bg="#80ffaa") #[O][O][ ][]
    button23.config(bg="#80ffaa")
#[][][][]
    button24.config(bg="#80ffaa") #[X][X][X][X]
    ...
    disableButtons
    start()
 # Cac dieu kien nguoi choi 2 [O] chien thang
